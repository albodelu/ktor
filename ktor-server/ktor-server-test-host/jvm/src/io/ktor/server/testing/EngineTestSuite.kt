...
abstract class EngineTestSuite<TEngine : ApplicationEngine, TConfiguration : ApplicationEngine.Configuration>(
    ...
    fun testLocalFileContentWithCompression() {
        val file =
            listOf(File("jvm/src"), File("ktor-server/ktor-server-core/jvm/src")).first { it.exists() }.walkBottomUp()
    ...
    fun testURIContentLocalFile() {
        ...
        val file = listOf(File("build/classes/kotlin/jvm/main"), File(buildDir)).first { it.exists() }.walkBottomUp()
...
//        }
    ...
    companion object {
        const val classesDir = "build/classes/kotlin/jvm/main"
